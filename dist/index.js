...
const sqs_1 = __importDefault(__nccwpck_require__(3172));
let region;
...
function getQueueUrl(queueName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield client.getQueueUrl({ QueueName: queueName }).promise();
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!queueUrl) {
            (0, core_1.info)(`The queue "${queueName}" doesn't exist. Skipping...`);
        }
        else {
            const result = yield client.deleteQueue({ QueueUrl: queueUrl }).promise();
            (0, core_1.info)(`The queue "${queueName}" was successfully deleted.`);
        }
        return 0;
    });
}
...
Object.defineProperty(apiLoader.services['sqs'], '2012-11-05', {
  get: function get() {
    var model = __nccwpck_require__(1635);
    model.paginators = __nccwpck_require__(8324)/* .pagination */ .o;
    return model;
  },
  enumerable: true,
  configurable: true
